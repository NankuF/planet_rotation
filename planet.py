...
def planet_rotation():
    ...
    pics_list = [pic1, pic2, pic3, pic4, pic5, pic6, pic7, pic8, pic9, pic10, pic11, pic12, pic13]

    n = 0
    while n < 13:
        print(f'{up_cursor}{clear_screen}', end='')
        print(f'{up_cursor}{green_color}{pics_list[n]}', end='')
        print(f'{up_cursor}{clear_screen}', end='')
        sleep(0.2)
        n += 1
        if n == 13:
